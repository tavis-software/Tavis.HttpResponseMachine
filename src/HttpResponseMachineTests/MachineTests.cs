...
namespace LinkTests
{
    public class MachineTests
    {
        ...
        public async Task Handle404()
        {
            ...
            await machine.HandleResponseAsync(null, new HttpResponseMessage(HttpStatusCode.NotFound));
        ...
        public async Task HandleUnknown4XX()
        {
            ...
            await machine.HandleResponseAsync(null, new HttpResponseMessage(HttpStatusCode.ExpectationFailed));
        ...
        public async Task Handle200AndContentType()
        {
            ...
            // Act
            await machine.HandleResponseAsync(null, new HttpResponseMessage(HttpStatusCode.OK) { Content = byteArrayContent});
        ...
        public async Task Handle200AndContentTypeAndLinkRelation()
        {
            ...
            // A
            await machine.HandleResponseAsync(new FakeLink { LinkRelation = "foolink" }, new HttpResponseMessage(HttpStatusCode.OK) { Content = byteArrayContent });
        ...
        public async Task DispatchBasedOnStatusCodeMediaTypeAndProfile()
        {
            ...
            machine.HandleResponseAsync(null, httpResponseMessage);
        ...
        public async Task DispatchBasedOnStatusCodeAndLinkRelationAndParseProfile()
        {
            ...
            // Allow machine to dispatch response
            machine.HandleResponseAsync(new FakeLink { LinkRelation = "person-link" }, httpResponseMessage);
        ...
        public async Task DispatchBasedOnMediaTypeWithParser()
        {
            ...
            machine.HandleResponseAsync(null, new HttpResponseMessage()
            {
                Content = jsonContent
            });
