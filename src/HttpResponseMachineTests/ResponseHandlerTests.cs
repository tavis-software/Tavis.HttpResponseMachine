...
namespace LinkTests
{
    public class ResponseHandlerTests 
    {
        ...
        {
            var link = new FakeLink(){Target = new Uri("http://localhost")};
        ...
        {
            var link = new FakeLink() {Target = new Uri("http://example.org/")};
    ...
    public class ClientApplicationState : IResponseHandler
    {
        ...
        public Task<HttpResponseMessage> HandleResponseAsync(IRequestFactory requestFactory, HttpResponseMessage responseMessage)
        {
